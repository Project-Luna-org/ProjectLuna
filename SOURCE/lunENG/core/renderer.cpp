...
:PointsVBO(0), numPoints(0), attributePoints(-1), UVsVBO(0), numUVs(0), attributeUVs(-1), drawingMode(drawingMode), PrimitiveType(PrimitiveType), shaderProc(shaderProc), numVertex(0), loc_inVertex(-1), loc_inTextCoords(-1), VAO(0)
{
